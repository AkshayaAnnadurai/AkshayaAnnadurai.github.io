  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          This website is a clone of Indeed, an Job Searching website. In this website
          you can search for a job and also you can post a job if you own an company.
        </p>

        <h3 style={{ color: "#B37D4E" }}>Tech stack:</h3>
        <p>React | CSS | JavaScript | ChakraUI</p>
        ...
        <div className={style.btndivv}>
          <button className={style.btnpro} style={{ backgroundColor: "black" }}>
            <a
              ...
              target="_blank"
              href="https://github.com/AkshayaAnnadurai/selective-memory-2410"
            >
              <span>
                <svg
                  style={{
          ...
          >
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://indeed-eight.vercel.app/"
            >
              <span>
                <svg
                  style={{
