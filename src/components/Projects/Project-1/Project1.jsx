...
import img1 from "./Anthropologie.png";
import img2 from "./anthcloth.png";
import img3 from "./antbasket.png";
import img4 from "./antpay.png";
  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          Anthropologie is an E-commerce website where we can buy new dresses
        ...
        <div className={style.btndivv}>
          <button className={style.btnpro} style={{ backgroundColor: "black" }}>
            <a
              ...
              target="_blank"
              href="https://github.com/BhanuPrathapGoud/clone-of-Anthropology-com-unit-3-project"
            >
              <span>
                <svg
                  style={{
          ...
          >
            <a
              href="https://profound-yeot-1d409e.netlify.app/"
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
            >
              <span>
